...
class GenericTextService
{
     ...
     * indépendamment de la question posée.
     *
     * @param string $question La question de l'utilisateur (ignorée)
     * @return string
     */
    public function getRandomGenericChatResponse(string $question): string
    {
        $responses = [
            ...
            "En analysant les théories fondamentales du document, on observe une corrélation forte entre l'état d'équilibre et les contraintes externes.\n\n" .
            ...
            "L'étude aborde un aspect critique de la distribution et de la probabilité de présence des éléments étudiés dans le document.\n\n" .
            ...
            "Il est fondamental de noter l'évolution temporelle du système et son niveau de désordre interne (entropie).\n\n" .
            ...
            "En analysant précisément la section de modélisation mathématique du document, nous pouvons introduire la relation de dispersion non-linéaire :\n" .
